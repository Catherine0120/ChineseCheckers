...
void MainWindow::displayRunTimeEnemyWin() {
    QMessageBox::critical(this, "3 RunOutOfTime", "You have run out of time 3 times");
    pE->setWindowModality(Qt::ApplicationModal);
    pE->show();
    chessselected = -1;
}

void MainWindow::displayRunTimeIWin() {
    QMessageBox::critical(this, "Enemy 3 RunOutOfTime", "Enemy has run out of time 3 times");
    pM->setWindowModality(Qt::ApplicationModal);
    pM->show();
    chessselected = -1;
}
